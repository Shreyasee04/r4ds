...
If not, you're likely to get an error that says the object you're looking for was not found.R is not case sensitive , you might use both capital or small letter but if you have used a particular case previously , you have to maintain that otherwise error will be shown .
